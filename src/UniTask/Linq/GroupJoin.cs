...
internal sealed class GroupJoinAwait<TOuter, TInner, TKey, TResult> : IUniTaskAsyncEnumerable<TResult>
{
    ...
    {
        private static readonly Action<object> MoveNextCoreDelegate = MoveNextCore;
        private readonly static Action<object> ResultSelectCoreDelegate = ResultSelectCore;
        private readonly static Action<object> OuterKeySelectCoreDelegate = OuterKeySelectCore;
